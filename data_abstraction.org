...
(define (make-center-percent center tolerance)
  (make-center-width center (width (* center tolerance))))

(make-center-percent (center i_1) .2)
#+END_SRC
...
#+BEGIN_SRC scheme
(make-center-percent (center i_1) 0.2) ; .7
(make-center-percent (center i_2) 0.2) ; .6
(make-center-percent (center (mul-interval i_1 i_2)) .2) ; 2.7
#+END_SRC

Intuitively, we may assume that we can do the following: 
